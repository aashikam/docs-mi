...
1. After saving, click on the package you just created to view its details.
   ...
   <img src="https://github.com/aashikam/docs-mi/blob/sfmc-check/en/docs/assets/img/integrate/connectors/sfmc/sfmc-component-details.png" title="SFMC new component details" width="95%" alt="SFMC installed package component details"/>
