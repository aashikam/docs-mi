...
1. Access the Email Templates Home. Within Email Studio, locate the Content section or Email Templates.
   ...
   <img src="https://github.com/aashikam/docs-mi/blob/sfmc-check/en/docs/assets/img/integrate/connectors/sfmc/email-template-home.png" title="Email Template Home" width="50%" alt="Email Template Home"/>

2. Click “New Email Template,” fill in the required details, and save.

   <img src="https://github.com/aashikam/docs-mi/blob/sfmc-check/en/docs/assets/img/integrate/connectors/sfmc/email-template-new.png" title="New Email Template" width="100%" alt="New Email Template"/>
...
3. Open the template details page and click "Edit in Builder." From there, you can modify the HTML, paste an existing template, or choose from their available templates. I have also added a custom HTML template, which you can find [here](https://gist.github.com/aashikam/999fc472ebc16e06be4e72f644fff55d).
   ...
   <img src="https://github.com/aashikam/docs-mi/blob/sfmc-check/en/docs/assets/img/integrate/connectors/sfmc/email-template-edit.png" title="Edit Email Template" width="5=100%" alt="Edit Email Template"/>
...
2. Choose “Create” and select your preferred email type (Template Based, HTML Paste, or Text Only).
   ...
   <img src="https://github.com/aashikam/docs-mi/blob/sfmc-check/en/docs/assets/img/integrate/connectors/sfmc/create-email.png" title="Create Email" width="100%" alt="Create Email"/>
...
4. Construct the email content according to the chosen format.
    ...
    <img src="https://github.com/aashikam/docs-mi/blob/sfmc-check/en/docs/assets/img/integrate/connectors/sfmc/email-content.png" title="Email Content" width="100%" alt="Email Content"/>
...
2. Find the “Sender Profiles” option in the left-hand menu.
    ...
    <img src="https://github.com/aashikam/docs-mi/blob/sfmc-check/en/docs/assets/img/integrate/connectors/sfmc/sender-profiles.png" title="Sender Profiles" width="30%" alt="Sender Profiles"/>

3. Click “Create” to make a new profile or select an existing profile to update.

    <img src="https://github.com/aashikam/docs-mi/blob/sfmc-check/en/docs/assets/img/integrate/connectors/sfmc/new-profile.png" title="New Profile" width="100%" alt="New Profile"/>
...
<img src="https://github.com/aashikam/docs-mi/blob/sfmc-check/en/docs/assets/img/integrate/connectors/sfmc/delivery-profile.png" title="Delivery Profile" width="100%" alt="Delivery Profile"/>
...
<img src="https://github.com/aashikam/docs-mi/blob/sfmc-check/en/docs/assets/img/integrate/connectors/sfmc/send-classification.png" title="Send Classification" width="100%" alt="Send Classification"/>
...
<img src="https://github.com/aashikam/docs-mi/blob/sfmc-check/en/docs/assets/img/integrate/connectors/sfmc/send-test-email.png" title="Send Test Email" width="100%" alt="Send Test Email"/>
